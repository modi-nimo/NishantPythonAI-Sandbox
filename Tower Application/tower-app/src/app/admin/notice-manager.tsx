    ...
    return (
        <div className="grid lg:grid-cols-12 gap-10">
            ...
            <div className="lg:col-span-4 lg:sticky lg:top-10 h-fit">
                <div className="glass-card p-10 rounded-[3rem] bg-slate-900 text-white space-y-8 shadow-2xl">
                    <div>
                        <h2 className="text-2xl font-black font-outfit uppercase tracking-tighter">Draft Update</h2>
                    ...
                    <form action={createNotice} className="space-y-6">
                        <div className="space-y-2">
                            <input
                                ...
                                className="w-full bg-white/5 border-none focus:ring-1 focus:ring-accent-500 p-4 rounded-2xl text-sm font-bold outline-none"
                            />
                        </div>
                        <div className="space-y-2">
                            <textarea
                                ...
                                className="w-full bg-white/5 border-none focus:ring-1 focus:ring-accent-500 p-4 rounded-2xl text-sm font-medium outline-none resize-none"
                            />
                        </div>
                        <div className="flex gap-2">
                            <select name="priority" className="flex-1 bg-white text-slate-900 p-4 rounded-2xl text-[10px] font-black uppercase tracking-widest outline-none appearance-none">
                                <option value="normal">Normal Priority</option>
                                <option value="urgent">Urgent + Telegram</option>
                            </select>
                            <Button type="submit" className="h-14 w-14 rounded-2xl bg-accent-500 hover:bg-accent-600 shadow-xl shadow-accent-500/20">
            ...
            <div className="lg:col-span-8 space-y-6">
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    {notices.map(n => (
                        <div key={n.id} className="glass-card p-6 rounded-[2rem] flex flex-col justify-between group">
                            <div className="space-y-3">
                                ...
                                <p className="text-xs text-gray-500 leading-relaxed line-clamp-3">{n.content}</p>
                            </div>
